...
let num:number | undefined  //here if i am specifically defining type then this will give error without undefined. as the code doesnt know if block will run or not
